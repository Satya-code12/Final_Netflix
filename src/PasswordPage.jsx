...
const Password_page=({email})=>{
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      alert("Email/ Password already is there....");
    }
  };
  ...
  <>
    <div
      ...
      >
       ...
       <input type="password" style={{width: "300px",height: "50px", margin: '25px auto 0 auto', padding: '5px'}} placeholder="Password" required onChange={(e)=>{
